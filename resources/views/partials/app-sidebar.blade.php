{{-- Desktop sidebar --}}
<aside class="hidden md:flex md:flex-col w-64 shrink-0 bg-primary-dark text-white/90 h-screen sticky top-0 border-r border-white/10">
    <div class="h-16 flex items-center gap-2 px-6 border-b border-white/10 shrink-0">
